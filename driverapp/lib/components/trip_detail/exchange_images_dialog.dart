...
class ExchangeImagesDialog extends StatefulWidget {
  final String reportId;
  final Function() onImagesUploaded;

  const ExchangeImagesDialog({
    Key? key,
  ...
  @override
  State<ExchangeImagesDialog> createState() => _ExchangeImagesDialogState();
}

class _ExchangeImagesDialogState extends State<ExchangeImagesDialog> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          AppBar(
            title: const Text('Thêm ảnh trao đổi'),
  ...
  Future<void> _uploadExchangeImages() async {
    ...
    try {
      ...
      final result = await _incidentReportService.uploadExchangeImages(
      ...
      if (result['success'] == true) {
        ...
        DialogHelper.showSnackBar(
          context: context,
          message: 'Tải lên ảnh trao đổi thành công',
          isError: false,
        );
...
class ExchangeImagesDialogHelper {
  static void show({
